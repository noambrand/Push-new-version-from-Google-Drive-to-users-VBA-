...
שיטה 1:  להוריד בלחיצת כפתור קובץ עדכני מגוגל דרייב .
שיטה 2: להוריד בלחיצת כפתור קובץ קוד עדכני מגוגל דרייב (עדכון קוד בלבד ללא החלפת הקובץ המקורי).
שיטה 3: לעדכן בלחיצת כפתור קוד בלבד מנתיב מקומי ברשת משותפת ( עדכון קוד בלבד ללא החלפת הקובץ המקורי).
